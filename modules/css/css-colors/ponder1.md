---
title: CSS Colors - Ponder activities
description: Practice using CSS colors
date: 2021-11-18
...
Change some of the element's default colors. You can use color names, hexidecimal values, or rgb notation. Use the styles.css file inside the styles folder to add the CSS required to do this.
